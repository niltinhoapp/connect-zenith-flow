...
export type ModuleCategory =
  "core" | "sales" | "communication" | "automation" | "intelligence" | "billing";
...
export const moduleRegistry: ModuleDefinition[] = [
  ...
  },
  {
    key: "crm",
    name: "CRM",
    description: "Pipeline de vendas em kanban.",
    category: "sales",
    route: "/crm",
    core: false,
  },
  ...
  },
  {
    key: "whatsapp",
    name: "WhatsApp",
    description: "Inbox e envio via WhatsApp Cloud API.",
  ...
  },
  {
    key: "ia",
    name: "IA",
    description: "Copilot e blocos de IA.",
  ...
  },
  {
    key: "configuracoes",
    name: "Configurações",
    description: "Workspace, time e integrações.",
    category: "core",
    route: "/configuracoes",
    core: true,
  },
  {
    key: "billing",
    name: "Cobrança",
    description: "Planos, assinatura e uso.",
    category: "billing",
    route: "/configuracoes",
    core: true,
  },
