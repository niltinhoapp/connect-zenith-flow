...
Pipeline de vendas em kanban: deals, estágios e movimentação drag-and-drop.

- **Module key:** `crm` — registered in `src/config/modules.ts`.
- **Current screens:** /crm (in `src/routes/`, unchanged during F0).
- **Activated in:** F2.
