...
Inbox omnichannel e envio de mensagens via WhatsApp Cloud API (conversas, templates, mídia).

- **Module key:** `whatsapp` — registered in `src/config/modules.ts`.
- **Current screens:** /whatsapp (in `src/routes/`, unchanged during F0).
- **Activated in:** F3.
