    ...
    >
      <div className="space-y-3">
        <Button
          type="button"
          variant="outline"
          className="h-10 w-full rounded-lg border-border bg-card"
        >
          <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24">
            <path
              fill="currentColor"
              d="M12 11v2h5.5c-.2 1.4-1.7 4-5.5 4-3.3 0-6-2.7-6-6s2.7-6 6-6c1.9 0 3.1.8 3.8 1.5l2.6-2.5C16.9 2.9 14.7 2 12 2 6.5 2 2 6.5 2 12s4.5 10 10 10c5.8 0 9.6-4.1 9.6-9.8 0-.7 0-1.2-.2-1.7H12z"
            />
          </svg>
