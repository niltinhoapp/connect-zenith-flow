      ...
      <form className="space-y-4">
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <div className="relative mt-1.5">
              ...
              <Input placeholder="Rafael" className="h-10 rounded-lg border-border bg-card pl-9" />
            </div>
          </div>
          <div>
            <Label className="text-xs">Sobrenome</Label>
            <Input placeholder="Alves" className="mt-1.5 h-10 rounded-lg border-border bg-card" />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative mt-1.5">
            ...
            <Input placeholder="Nome da empresa" className="h-10 rounded-lg border-border bg-card pl-9" />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative mt-1.5">
            ...
            <Input type="password" placeholder="Mínimo 8 caracteres" className="h-10 rounded-lg border-border bg-card pl-9" />
          </div>
