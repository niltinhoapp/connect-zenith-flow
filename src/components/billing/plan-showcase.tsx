...
import { CONNECTWEB_PLAN, IA_PACKAGES, formatBRL, formatCredits, type IaPackage } from "./commercial";
      ...
      <SectionCard title="Seu plano" description="Plano único, tudo incluído">
        ...
        <div className="mt-4 flex items-start gap-2 rounded-lg border border-border bg-muted/30 p-3 text-xs text-muted-foreground">
          ...
          <span>
            ...
            <span className="font-medium text-foreground">não estão incluídas</span> na mensalidade da
            ConnectWeb.
          </span>
        </div>
      </SectionCard>
          ...
          {IA_PACKAGES.map((pkg) => (
            <div
              ...
              className={cn(
                ...
                pkg.highlight ? "border-primary/40 ring-1 ring-inset ring-primary/20" : "border-border",
              )}
            >
